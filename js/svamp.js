...
const url = `https://dnrbmiiducergeuxsuzz.supabase.co/rest/v1/vildmad/` + id;
console.log("lort");
fetch(url, {
  method: "GET",
  headers: {
...
function showProduct(mushroom) {
  ...
  document.querySelector("h1").textContent = mushroom[0].title;
  document.querySelector(".beskrivelse p").textContent = mushroom[0].decription;
  document.querySelector(".grid1 img").src = mushroom[0].images;
}
